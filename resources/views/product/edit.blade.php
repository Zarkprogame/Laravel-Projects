    ...
    <div class="container">
        <div class="col-12 text-center">
            <div class="alert alert-success" role="alert">
                <h1 class="mb-0" style="color: green;">Editar Productos</h1>
            </div>
        </div>
        <p></p>
        <p></p>
                ...
                <div class="row" style="width: 120%; padding-left: 220px;">
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="price" name="price" placeholder="Precio" value="{{$product->price}}">
                        </div>
                    </div>
                </div>
                <div class="row" style="width: 120%; padding-left: 220px;">
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="stock" name="stock" placeholder="Cantidad" value="{{$product->stock}}">
                        </div>
                    </div>
                </div>
                <div class="row"style="width: 120%; padding-left: 220px;">
